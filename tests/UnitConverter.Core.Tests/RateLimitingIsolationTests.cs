...
/// 3. AddCoreResilience is truly generic and reusable
/// </summary>
public class RateLimitingIsolationTests
{
    ...
    public void Each_Service_Has_Isolated_RateLimiting_Configuration()
    {
        ...
        authServices.AddCoreResilience(authConfig);
        catalogServices.AddCoreResilience(catalogConfig);
    ...
    public void Core_Resilience_Works_With_Empty_Configuration()
    {
        ...
        {
            services.AddCoreResilience(emptyConfig);
    ...
    /// </summary>
    [Fact]
    public void AddCoreResilience_Does_Not_Affect_Existing_Registrations()
    {
        // Arrange
        var services = new ServiceCollection();
        ...
        // Act
        services.AddCoreResilience(config);
