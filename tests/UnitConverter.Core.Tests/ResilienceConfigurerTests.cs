...
/// 5. Multiple services can use AddCoreResilience independently
/// </summary>
public class ResilienceConfigurerTests
{
    ...
    /// </summary>
    [Fact]
    public void AddCoreResilience_Registers_IResilienceConfigurer()
    {
        // Arrange
        ...
        // Act
        services.AddCoreResilience(configuration);
    ...
    /// <summary>
    /// Test 2: AddCoreResilience properly configures rate limiting in the container
    /// </summary>
    [Fact]
    public void AddCoreResilience_Configures_RateLimiter()
    {
        // Arrange
        var services = new ServiceCollection();
        var configuration = new ConfigurationBuilder().Build();
    ...
    /// <summary>
    /// Test 5: Multiple services can independently use AddCoreResilience
    /// proving Core is decoupled and reusable
    /// </summary>
    [Fact]
    public void Multiple_Services_Can_Use_AddCoreResilience_Independently()
    {
        ...
        authServices.AddCoreResilience(configuration);
        catalogServices.AddCoreResilience(configuration);
        conversionServices.AddCoreResilience(configuration);
